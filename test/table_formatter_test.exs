defmodule TableFormatterTest do
  ...
  import ExUnit.CaptureIO # And allow us to caputre stuff sent to stdout
  ...
  def split_with_three_columns do
    TF.split_into_columns(@simple_test_data, @header)
  end
  ...
  test "correct format string returned" do
    assert TF.format_of([9, 10, 11]) == "~-9s | ~-10s | ~-11s~n"
  end
